...
-- Coluna do subtítulo introdutório da seção "Nossa Localização"
...
SET
    ...
    p.`loc_subtitulo` = 'Estamos localizados no coração do litoral catarinense. Em meio a natureza e com total tranquilidade.',
