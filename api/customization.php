...
try {
    $pdo->exec("ALTER TABLE personalizacao ADD COLUMN loc_subtitulo TEXT NULL AFTER loc_endereco");
} catch (Throwable $e) {
    // Coluna já existe.
}
