...
INSERT INTO `personalizacao` (
  ...
  `loc_endereco`, `loc_subtitulo`, `loc_carro`, `loc_map_link`, `loc_map_embed`,
  ...
  'Estamos localizados no coração do litoral catarinense. Em meio a natureza e com total tranquilidade.',
